...
public class ModEntities {
	...
	public static EntityType<Prisoner> PRISONER = register("winksmod:prisoner", EntityType.Builder.<Prisoner>create(Prisoner::new, EntityClassification.MONSTER).size(0.5F, 0.5F));
