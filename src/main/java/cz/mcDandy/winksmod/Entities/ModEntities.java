...
public class ModEntities {
	...
	public static EntityType<SkeletonBandit> SKELETON_BANDIT = register("winksmod:skeleton_bandit", EntityType.Builder.<SkeletonBandit>create(SkeletonBandit::new, EntityClassification.MONSTER).size(0.5F, 0.5F));
