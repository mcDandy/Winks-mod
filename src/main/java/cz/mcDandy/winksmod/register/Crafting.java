...
public class Crafting {
	public static void Register(FMLInitializationEvent event) {
		...
		GameRegistry.addShapedRecipe(new ItemStack(ModItems.solwand,1,ModItems.magicdiamond.getDamage(new ItemStack(ModItems.magicdiamond))), new Object[] {"X  "," A ","  A",'X',ModItems.magicdiamond,'A',ModItems.fpowder}); 
